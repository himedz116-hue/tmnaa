        ...
        >
          {badges.map((badge, i) => (
            <motion.div
              ...
              className="premium-badge px-4 py-2 md:px-5 md:py-2.5 rounded-full cursor-default"
              style={{
            ...
            >
              <span
                className="relative z-10 text-[11px] md:text-[13px] font-bold tracking-wider"
